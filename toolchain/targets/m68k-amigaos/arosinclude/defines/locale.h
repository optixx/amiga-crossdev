#ifndef DEFINES_LOCALE_PROTOS_H
#define DEFINES_LOCALE_PROTOS_H
...
#define __FormatDate_WB(__LocaleBase, __arg1, __arg2, __arg3, __arg4) \
        AROS_LC4(void, FormatDate, \
                  ...
                  AROS_LCA(struct DateStamp *,(__arg3),A2), \
...
({ \
    ...
    OpenCatalogA((arg1), (arg2), (struct TagItem *)__args); \
})
