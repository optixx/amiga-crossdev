#ifndef DEFINES_COMMODITIES_PROTOS_H
#define DEFINES_COMMODITIES_PROTOS_H
...
#define __GetBrokerList_WB(__CxBase, __arg1) \
        AROS_LC1(LONG, GetBrokerList, \
                  AROS_LCA(struct List *,(__arg1),A0), \
        struct Library *, (__CxBase), 31, Commodities)

#define GetBrokerList(arg1) \
    __GetBrokerList_WB(CxBase, (arg1))

#define __FreeBrokerList_WB(__CxBase, __arg1) \
        AROS_LC1(void, FreeBrokerList, \
                  AROS_LCA(struct List *,(__arg1),A0), \
...
#define __CxNotify_WB(__CxBase, __arg1, __arg2) \
        AROS_LC2(ULONG, CxNotify, \
                  AROS_LCA(STRPTR,(__arg1),A0), \
                  AROS_LCA(ULONG,(__arg2),D0), \
        struct Library *, (__CxBase), 33, Commodities)

#define CxNotify(arg1, arg2) \
    __CxNotify_WB(CxBase, (arg1), (arg2))
...
#endif /* DEFINES_COMMODITIES_PROTOS_H*/
