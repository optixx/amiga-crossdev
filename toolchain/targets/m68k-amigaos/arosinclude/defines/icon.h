#ifndef DEFINES_ICON_PROTOS_H
#define DEFINES_ICON_PROTOS_H
...
({ \
    IPTR __args[] = { AROS_PP_VARIADIC_CAST2IPTR(__VA_ARGS__) }; \
    GetIconTagList((arg1), (struct TagItem *)__args); \
})
#endif /* !NO_INLINE_STDARG */
...
#define __ChangeToSelectedIconColor_WB(__IconBase, __arg1) \
        AROS_LC1(void, ChangeToSelectedIconColor, \
