#ifndef DEFINES_PARTITION_PROTOS_H
#define DEFINES_PARTITION_PROTOS_H
...
#define __CloseRootPartition_WB(__PartitionBase, __arg1) \
        AROS_LC1(void, CloseRootPartition, \
...
#define __ClosePartitionTable_WB(__PartitionBase, __arg1) \
        AROS_LC1(void, ClosePartitionTable, \
                  AROS_LCA(struct PartitionHandle *,(__arg1),A1), \
...
#endif /* DEFINES_PARTITION_PROTOS_H*/
