#ifndef DEFINES_MATHIEEESINGBAS_PROTOS_H
#define DEFINES_MATHIEEESINGBAS_PROTOS_H

/*
    *** Automatically generated from 'mathieeesingbas.conf'. Edits will be lost. ***
...
#endif /* DEFINES_MATHIEEESINGBAS_PROTOS_H*/
